    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#f8f8f6] py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-[#0a0a0a] mb-4">Our Services</h1>
      ...
      <section className="py-16 bg-[#0a0a0a]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <p className="text-3xl md:text-4xl font-bold text-white mb-2">50K+</p>
              <p className="text-sm text-gray-500">Repairs Completed</p>
            </div>
            <div>
            ...
            <div>
              <p className="text-3xl md:text-4xl font-bold text-white mb-2">4.9</p>
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#6b6b6b] max-w-2xl mx-auto">
              Fast, reliable repairs by certified technicians using genuine parts
            </p>
          </div>
                ...
                <div className="p-8">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#6b6b6b]">{service.price} &middot; {service.turnaround}</p>
                    </div>
                  </div>

                  <p className="text-[#404040] mb-6 leading-relaxed text-sm">{service.description}</p>

                  {/* Features */}
                  <ul className="space-y-3 mb-6">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start text-[#404040]">
                        <svg
                  ...
                  <a
                    ...
                    className="block text-center px-4 py-3 bg-[#0066ff] text-white rounded-xl font-semibold text-sm hover:bg-[#0052cc] transition-colors duration-200"
                  >
                    Book Now
                  </a>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a
                    ...
                    className="inline-flex items-center justify-center px-6 py-3 bg-white text-[#0a0a0a] rounded-xl font-semibold hover:bg-gray-100 transition-colors duration-200"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center px-6 py-3 bg-[#25d366] text-white rounded-xl font-semibold hover:bg-[#20bd5a] transition-colors duration-200"
                  >
              ...
              <div className="hidden md:flex justify-center items-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-400">Available for Most Repairs</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {warrantyPlans.map((plan, index) => (
              ...
              >
                {plan.popular && (
                  <div className="inline-block bg-[#0066ff] text-white px-3 py-1 rounded-lg text-xs font-semibold mb-4">
                    Most Popular
                  </div>
                )}
                <h3 className="text-xl font-bold mb-2">{plan.name}</h3>
                <p className={`text-base mb-4 ${plan.popular ? 'text-gray-400' : 'text-[#6b6b6b]'}`}>
                  {plan.duration}
                </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {[
              ...
              <div key={index}>
                <div className="bg-[#f8f8f6] rounded-2xl p-6 border border-gray-100 text-center h-full flex flex-col items-center hover:shadow-sm transition-all duration-200">
                  {/* Step Number */}
                  <div className="w-12 h-12 bg-[#0066ff] text-white rounded-full flex items-center justify-center text-lg font-bold mb-4">
                    {item.step}
                  </div>
