          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a href="tel:+254743816791" className="hover:text-white transition-colors block">
                    +254 743 816 791
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:info@gadgetsbykihoro.com" className="hover:text-white transition-colors">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="https://wa.me/254743816791" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  WhatsApp Us
                </a>
              </li>
            </ul>
