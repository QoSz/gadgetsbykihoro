      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>7th Floor, The Oval Westlands<br/>Ring Road Parklands, Nairobi</span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a href="tel:+254788740000" className="hover:text-white transition-colors block">
                    +254 788 740 000
                  </a>
                  <a href="tel:+254722740000" className="hover:text-white transition-colors block">
                    +254 722 740 000
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:sales@fonexpress.net" className="hover:text-white transition-colors">
                  sales@fonexpress.net
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="https://wa.me/254788740000" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  WhatsApp Us
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            © {currentYear} FoneXpress. All rights reserved.
          </p>
