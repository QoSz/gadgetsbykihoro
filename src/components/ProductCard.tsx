      ...
      <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col h-full">
        ...
        <div className="relative flex-shrink-0">
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-2">
            {product.badge && (
              <div className="bg-[#007aff] text-white px-3 py-1 rounded-md text-xs font-bold shadow-lg">
                {product.badge}
              </div>
            )}
        ...
        <div className="p-5 flex flex-col flex-grow">
          ...
          <div className="flex items-center justify-between mb-2">
            <p className="text-xs font-semibold text-[#007aff] uppercase">{product.brand}</p>
            {product.kcbEligible && (
          ...
          {/* Product Name */}
          <h3 className="text-base font-bold text-gray-900 mb-2 group-hover:text-[#007aff] transition-colors line-clamp-2 min-h-[3rem]">
            {product.name}
          </h3>
          ...
          <div className="flex flex-col gap-2 mt-auto">
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="text-center px-4 py-2.5 bg-[#007aff] text-white rounded-lg font-semibold text-sm hover:bg-[#0056b3] transition-all disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
              ...
              <div className="flex flex-col">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-sm font-semibold text-[#007aff] uppercase">{product.brand}</span>
                  <button
                ...
                <div className="flex flex-col gap-3">
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      onClick={handleBuyNow}
                      disabled={product.stock === 0}
                      className="w-full px-6 py-4 bg-[#007aff] text-white rounded-lg font-bold text-base hover:bg-[#0056b3] transition-all disabled:bg-gray-300 disabled:cursor-not-allowed shadow-lg flex items-center justify-center gap-2"
                    >
